...
/// <summary>
/// Entry point for the FHIR Anonymizer CLI tool.
/// </summary>
class Program
{
    static async Task<int> Main(string[] args)
    {
        var rootCommand = new RootCommand("FHIR data anonymization tool supporting multiple FHIR versions");
    ...
    {
        var command = new Command(versionCode, $"Anonymize FHIR {versionCode.ToUpperInvariant()} resources");
        command.Subcommands.Add(AnonymizeCommand.Create(schema));
