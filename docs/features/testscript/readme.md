...
| [azure-load-testing](investigations/azure-load-testing.md) | Viable | Compile the supported TestScript HTTP subset to Locust for Azure Load Testing while retaining Ignixa as the conformance authority |
