...
namespace Ignixa.FhirPath.Phase3.R4B.Tests;

public class R4BNativeFirelyPhase3SliceTests
{
    ...
    private static readonly IFhirSchemaProvider Schema = FhirVersion.R4B.GetSchemaProvider();

    [Fact]
    public void GivenNativeR4BChoice_WhenShippedCapitalizedDateCastEvaluated_ThenKnownDivergenceIsVisible()
    {
        // Arrange
    ...
    [Fact]
    public void GivenNativeR4BChoice_WhenLowercaseDateCastEvaluated_ThenProvidersReturnTheDate()
    {
        // Arrange
    ...
    [Fact]
    public void GivenNativeR4BChoice_WhenProductionIndexed_ThenCapitalizedDateCompositeIsEmitted()
    {
        // Arrange
        var definitions = CreateDefinitions();
