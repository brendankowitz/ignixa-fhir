...
public class FhirPathAggregateTests
{
    ...
    public void GivenIntegerCollection_WhenSum_ThenReturnsIntegerSum()
    {
        ...
        var expr = _compiler.Parse("(1 | 2 | 3 | 4 | 5).sum()");
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(1.5 | 2.3 | 3.7).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenMixedIntegerDecimal_WhenSum_ThenReturnsDecimalSum()
    {
        ...
        var expr = _compiler.Parse("(1 | 2.5 | 3).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenQuantityCollection_WhenSum_ThenReturnsQuantitySum()
    {
        ...
        var expr = _compiler.Parse("((5 'mg') | (3 'mg') | (2 'mg')).sum()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(42).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenCollectionWithNull_WhenSum_ThenIgnoresNull()
    {
        ...
        var expr = _compiler.Parse("(1 | {} | 3).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenIntegerCollection_WhenMin_ThenReturnsMinimum()
    {
        ...
        var expr = _compiler.Parse("(5 | 3 | 8 | 1 | 9).min()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(5.5 | 3.2 | 8.9 | 1.1).min()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("('apple' | 'banana' | 'cherry').min()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(@2024-01-15 | @2024-01-10 | @2024-01-20).min()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("((5 'mg') | (3 'mg') | (8 'mg')).min()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(42).min()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenIntegerCollection_WhenMax_ThenReturnsMaximum()
    {
        ...
        var expr = _compiler.Parse("(5 | 3 | 8 | 1 | 9).max()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(5.5 | 3.2 | 8.9 | 1.1).max()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("('apple' | 'banana' | 'cherry').max()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(@2024-01-15T10:00:00Z | @2024-01-10T10:00:00Z | @2024-01-20T10:00:00Z).max()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("((5 'mg') | (3 'mg') | (8 'mg')).max()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenIntegerCollection_WhenAvg_ThenReturnsDecimalAverage()
    {
        ...
        var expr = _compiler.Parse("(1 | 2 | 3 | 4 | 5).avg()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(1.5 | 2.5 | 3.5).avg()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenQuantityCollection_WhenAvg_ThenReturnsQuantityAverage()
    {
        ...
        var expr = _compiler.Parse("((5 'mg') | (3 'mg') | (4 'mg')).avg()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(42).avg()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(10 | 20 | 30).avg()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenTemperatureReadings_WhenAvg_ThenReturnsAverageTemperature()
    {
        ...
        var expr = _compiler.Parse("((37.0 'Cel') | (37.5 'Cel') | (36.8 'Cel')).avg()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenMedicationDosages_WhenSum_ThenReturnsTotalDose()
    {
        ...
        var expr = _compiler.Parse("((5 'mg') | (5 'mg') | (10 'mg')).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenEncounterDiagnoses_WhenMaxRank_ThenValidatesAgainstCount()
    {
        ...
        var expr = _compiler.Parse("(1 | 2 | 3).max() <= 3");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(-5 | 10 | -3).sum()");
        var root = CreateIntegerElement(0);
    ...
    {
        // Arrange
        var expr = _compiler.Parse("(999999999 | 1).sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenMixedTypesInvalid_WhenSum_ThenReturnsEmpty()
    {
        ...
        var expr = _compiler.Parse("(1 | 'text').sum()");
        var root = CreateIntegerElement(0);
    ...
    public void GivenQuantitiesDifferentUnits_WhenSum_ThenReturnsEmpty()
    {
        ...
        var expr = _compiler.Parse("((5 'mg') | (1 'kg')).sum()");
        var root = CreateIntegerElement(0);
