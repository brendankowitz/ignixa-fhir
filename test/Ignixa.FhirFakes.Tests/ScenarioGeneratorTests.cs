...
public class ScenarioGeneratorTests
{
    ...
    public void GivenDiabeticPatientScenario_WhenSeverityVaries_ThenA1cValuesReflectSeverity(int severity)
    {
        ...
        {
            var value = ((IMutableJsonNode)obs).MutableNode["valueQuantity"]?["value"]?.GetValue<decimal>();
    ...
    public void GivenHypertensivePatientScenario_WhenGenerated_ThenCreatesBloodPressureObservations()
    {
        ...
        {
            var components = ((IMutableJsonNode)bp).MutableNode["component"];
    ...
    public void GivenAsthmaticChildScenario_WhenGenerated_ThenIncludesExacerbationVisit()
    {
        ...
        {
            var classCode = ((IMutableJsonNode)e).MutableNode["class"]?["code"]?.GetValue<string>();
    ...
    public void GivenScenarioBuilder_WhenAddingDelay_ThenAdvancesTime()
    {
        ...
        var visit1Start = ((IMutableJsonNode)scenario.Encounters[0]).MutableNode["period"]?["start"]?.GetValue<string>();
        var visit2Start = ((IMutableJsonNode)scenario.Encounters[1]).MutableNode["period"]?["start"]?.GetValue<string>();
