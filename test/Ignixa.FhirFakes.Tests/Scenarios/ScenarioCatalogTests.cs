...
public class ScenarioCatalogTests
{
    ...
    public void GivenParameterOverride_WhenInvoking_ThenOverriddenValueChangesGeneratedPatient()
    {
        ...
        var defaultBirthYear = int.Parse(((IMutableJsonNode)defaultContext.Patient!).MutableNode["birthDate"]!.ToString()![..4]);
        var overriddenBirthYear = int.Parse(((IMutableJsonNode)overriddenContext.Patient!).MutableNode["birthDate"]!.ToString()![..4]);
