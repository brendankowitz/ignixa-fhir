...
namespace Ignixa.Application.Experimental.Features.Mcp.Dtos;

/// <summary>
/// DTO representing a background job summary (import/export) for MCP tool responses.
/// Optimized for LLM consumption with essential job status information.
/// </summary>
