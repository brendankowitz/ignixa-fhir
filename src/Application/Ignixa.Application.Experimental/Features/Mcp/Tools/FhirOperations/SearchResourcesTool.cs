...
using Ignixa.Application.Experimental.Features.Mcp.Dtos;
using Ignixa.Application.Experimental.Features.Mcp.Tools;
...
namespace Ignixa.Application.Experimental.Features.Mcp.Tools.FhirOperations;
