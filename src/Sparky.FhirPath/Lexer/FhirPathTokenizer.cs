...
public static class FhirPathTokenizer
{
        ...
        public static Tokenizer<FhirPathTokenKind> CreateWithTrivia()
        {
            return new TokenizerBuilder<FhirPathTokenKind>()
                ...
                .Match(Span.EqualTo("and"), FhirPathTokenKind.And, requireDelimiters: true)
                .Match(Span.EqualTo("or"), FhirPathTokenKind.Or, requireDelimiters: true)
                .Match(Span.EqualTo("xor"), FhirPathTokenKind.Xor, requireDelimiters: true)
                .Match(Span.EqualTo("implies"), FhirPathTokenKind.Implies, requireDelimiters: true)
                .Match(Span.EqualTo("is"), FhirPathTokenKind.Is, requireDelimiters: true)
                .Match(Span.EqualTo("as"), FhirPathTokenKind.As, requireDelimiters: true)
                .Match(Span.EqualTo("div"), FhirPathTokenKind.Div, requireDelimiters: true)
                .Match(Span.EqualTo("mod"), FhirPathTokenKind.Mod, requireDelimiters: true)
                .Match(Span.EqualTo("in"), FhirPathTokenKind.In, requireDelimiters: true)
                .Match(Span.EqualTo("contains"), FhirPathTokenKind.Contains, requireDelimiters: true)
