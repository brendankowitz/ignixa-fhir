...
namespace Sparky.FhirPath.Lexer;
...
public static class FhirPathTokenizer
{
        ...
        public static Tokenizer<FhirPathTokenKind> CreateWithTrivia()
        {
            return new TokenizerBuilder<FhirPathTokenKind>()
                ...
                // Keywords (must come before identifiers, case-insensitive, require word boundary)
                .Match(Span.EqualToIgnoreCase("and"), FhirPathTokenKind.And, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("or"), FhirPathTokenKind.Or, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("xor"), FhirPathTokenKind.Xor, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("implies"), FhirPathTokenKind.Implies, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("is"), FhirPathTokenKind.Is, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("as"), FhirPathTokenKind.As, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("div"), FhirPathTokenKind.Div, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("mod"), FhirPathTokenKind.Mod, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("in"), FhirPathTokenKind.In, requireDelimiters: true)
                .Match(Span.EqualToIgnoreCase("contains"), FhirPathTokenKind.Contains, requireDelimiters: true)

                // Boolean literals (keywords, case-sensitive per spec)
                .Match(Span.EqualTo("true"), FhirPathTokenKind.BooleanLiteral, requireDelimiters: true)
                .Match(Span.EqualTo("false"), FhirPathTokenKind.BooleanLiteral, requireDelimiters: true)
