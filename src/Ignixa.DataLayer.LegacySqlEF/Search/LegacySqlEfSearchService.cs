...
using Ignixa.DataLayer.LegacySqlEF.Entities;
using Ignixa.Domain.Abstractions;
using Ignixa.Domain.Models;
using Ignixa.Search.Expressions;
using Ignixa.Search.Models;

namespace Ignixa.DataLayer.LegacySqlEF.Search;
...
/// </summary>
public class LegacySqlEfSearchService : ISearchService
{
    ...
    private readonly ILogger<LegacySqlEfSearchService> _logger;

    /// <summary>
    /// Initializes a new instance of the <see cref="LegacySqlEfSearchService"/> class.
    /// </summary>
    ...
    public LegacySqlEfSearchService(
        ...
        ILogger<LegacySqlEfSearchService> logger)
    {
