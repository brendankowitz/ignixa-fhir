...
/// deliberately not collected here: the design doc's <c>ResourceSource</c>/<c>ParamSource</c> nodes
/// that need it are synthesized by Lower (Phase 5) from context this visitor does not have --
/// notably the query's own target resource type, which lives on the surrounding SemanticQuery, not
/// anywhere in this <see cref="Expression"/> tree. See Resolve's remarks for the full argument.
/// </remarks>
