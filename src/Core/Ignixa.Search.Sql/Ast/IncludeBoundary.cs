...
/// paging the UNION ALL of every stage as one stream — one boundary, not one per stage, or rows drop or
/// duplicate at the page seam. Both fields bind as parameters so plan reuse survives across pages.
/// </summary>
