...
public static class TokenTokenLoweringRule
{
        ...
        short resourceTypeId)
    {
        ...
        var predicate = new Predicate.And(
            TokenColumnEquality.Build(table, "SystemId1", "Code1", "CodeOverflow1", (TokenSearchValue)components[0].Value, context),
            TokenColumnEquality.Build(table, "SystemId2", "Code2", "CodeOverflow2", (TokenSearchValue)components[1].Value, context));
