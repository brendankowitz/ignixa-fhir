...
/// <summary>
/// Discriminator for the <c>StructureMapGroupRuleSource.defaultValue[x]</c> choice element: which typed
...
/// </remarks>
public enum StructureMapGroupRuleSourceDefaultValueType
{
    None,
    Base64Binary,
    Boolean,
