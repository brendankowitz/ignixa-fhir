...
/// <summary>
/// Discriminator for the <c>StructureMapGroupRuleTargetParameter.value[x]</c> choice element: which typed
...
/// </remarks>
public enum StructureMapGroupRuleTargetParameterValueType
{
    None,
    Id,
    String,
