...
/// <summary>
/// Discriminator for the <c>ConceptMapGroupElementTargetDependsOn.value[x]</c> choice element: which typed
...
/// </remarks>
public enum ConceptMapGroupElementTargetDependsOnValueType
{
    None,
    Code,
    Coding,
