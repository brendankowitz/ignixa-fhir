...
public static class HypertensivePatientScenario
{
    ...
    [Scenario(Category = "Chronic", Title = "Hypertension", Description = "ACE inhibitor treatment with monthly blood pressure monitoring and escalation.", Domain = ClinicalDomain.Cardiology)]
