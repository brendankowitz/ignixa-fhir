...
/// <summary>
/// Handler that validates input FHIR resources before de-identification.
/// Only performs validation when enabled in settings.
/// </summary>
internal sealed class ValidationHandler(ILogger<ValidationHandler> logger, IValidationSchemaResolver schemaResolver) : DeIdPipelineHandler
{
