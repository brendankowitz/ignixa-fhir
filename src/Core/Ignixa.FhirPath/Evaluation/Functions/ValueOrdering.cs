...
internal static class ValueOrdering
{
    ...
    /// <summary>
    /// Adapts <see cref="CompareForSort"/> to <see cref="IComparer{T}"/> for <c>sort()</c>.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    internal sealed class SortComparer : IComparer<IElement?>
    {
        ...
        public int Compare(IElement? x, IElement? y)
        {
            ...
            return CompareForSort(x!, y!, Function);
        }
        ...
        {
            return element is not null && (element.Value is not null || AsQuantity(element) is not null);
        }
    }
}
