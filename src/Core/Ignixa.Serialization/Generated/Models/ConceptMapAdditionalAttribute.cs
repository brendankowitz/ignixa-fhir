...
/// <summary>
/// FHIR ConceptMapAdditionalAttribute datatype facade. Zero-copy view over the underlying JsonObject.
/// </summary>
[CompatibleFhirVersions(global::Ignixa.Abstractions.FhirVersion.R5)]
public partial class ConceptMapAdditionalAttribute : BaseJsonNode
{
    public ConceptMapAdditionalAttribute()
    {
    }

    public ConceptMapAdditionalAttribute(JsonObject jsonObject, FhirVersion? fhirVersion = null)
