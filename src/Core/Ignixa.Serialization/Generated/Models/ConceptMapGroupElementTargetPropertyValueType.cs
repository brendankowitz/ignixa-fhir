...
/// <summary>
/// Discriminator for the <c>ConceptMapGroupElementTargetProperty.value[x]</c> choice element: which typed
...
/// </remarks>
public enum ConceptMapGroupElementTargetPropertyValueType
{
    None,
    Coding,
    String,
