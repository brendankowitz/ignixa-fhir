...
/// <summary>
/// FHIR StructureDefinitionSnapshot datatype facade. Zero-copy view over the underlying JsonObject.
/// </summary>
[CompatibleFhirVersions(global::Ignixa.Abstractions.FhirVersion.R4, global::Ignixa.Abstractions.FhirVersion.R5)]
public sealed partial class StructureDefinitionSnapshot : BaseJsonNode
{
    public StructureDefinitionSnapshot()
    {
    }

    public StructureDefinitionSnapshot(JsonObject jsonObject, FhirVersion? fhirVersion = null)
