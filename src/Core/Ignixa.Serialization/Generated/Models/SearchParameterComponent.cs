...
/// <summary>
/// FHIR SearchParameterComponent datatype facade. Zero-copy view over the underlying JsonObject.
/// </summary>
[CompatibleFhirVersions(global::Ignixa.Abstractions.FhirVersion.R4, global::Ignixa.Abstractions.FhirVersion.R5)]
public sealed partial class SearchParameterComponent : BaseJsonNode
{
    public SearchParameterComponent()
    {
    }

    public SearchParameterComponent(JsonObject jsonObject, FhirVersion? fhirVersion = null)
