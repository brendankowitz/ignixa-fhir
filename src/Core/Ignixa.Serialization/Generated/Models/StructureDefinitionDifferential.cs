...
/// <summary>
/// FHIR StructureDefinitionDifferential datatype facade. Zero-copy view over the underlying JsonObject.
/// </summary>
[CompatibleFhirVersions(global::Ignixa.Abstractions.FhirVersion.R4, global::Ignixa.Abstractions.FhirVersion.R5)]
public sealed partial class StructureDefinitionDifferential : BaseJsonNode
{
    public StructureDefinitionDifferential()
    {
    }

    public StructureDefinitionDifferential(JsonObject jsonObject, FhirVersion? fhirVersion = null)
        : base(jsonObject, fhirVersion)
    {
    }

    [JsonIgnore]
    public MutableJsonList<ElementDefinition> Element => GetListProperty<ElementDefinition>("element");
