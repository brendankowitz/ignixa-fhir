...
/// <summary>
/// FHIR StructureDefinitionContext datatype facade. Zero-copy view over the underlying JsonObject.
/// </summary>
[CompatibleFhirVersions(global::Ignixa.Abstractions.FhirVersion.R4, global::Ignixa.Abstractions.FhirVersion.R5)]
public sealed partial class StructureDefinitionContext : BaseJsonNode
{
    public StructureDefinitionContext()
    {
    }

    public StructureDefinitionContext(JsonObject jsonObject, FhirVersion? fhirVersion = null)
    ...
    {
        get => EnumUtility.ParseLiteral<ExtensionContextType>(GetProperty<string>("type"));
