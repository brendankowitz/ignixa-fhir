...
public sealed record LastNSearchOptions
{
    ...
    /// <param name="maximum">The number of sorted positions to retain per code group, including boundary ties.</param>
    ...
    /// <summary>Gets the number of sorted positions to retain per code group, including boundary ties.</summary>
