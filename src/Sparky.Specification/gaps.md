...
- [x] Version-agnostic validation framework (Sparky.Validation project)
...
**2. Version-Agnostic Validation (Sparky.Validation)**
...
- Dependencies: Sparky.Specification, Sparky.SourceNodeSerialization only
