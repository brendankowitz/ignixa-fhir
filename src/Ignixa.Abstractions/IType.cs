...
/// </summary>
/// <remarks>
/// This interface is the modern replacement for <see cref="IElementDefinitionSummary"/>.
...
public interface IType
{
    ...
    /// <summary>
    /// XML representation mode (element, attribute, text, etc.).
    /// REQUIRED for XML serialization only.
    /// </summary>
