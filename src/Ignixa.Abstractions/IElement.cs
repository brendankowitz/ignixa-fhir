...
public interface IElement
{
    ...
    /// <summary>
    /// Retrieves an annotation of the specified type.
    /// Used for attaching metadata (e.g., source JsonNode, validation state).
    /// </summary>
    /// <typeparam name="T">Annotation type to retrieve</typeparam>
    /// <returns>Annotation instance or null if not present</returns>
