-- Minimal FHIR schema for testing (no partitions)
USE Fhir_Tenant2;
GO
...
-- System table (for token and reference search params)
...
(
    ...
    CodeOverflow varbinary(max) NULL,
    IsHistory bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_TokenSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId, Code),
...
-- StringSearchParam table
CREATE TABLE dbo.StringSearchParam
(
    ResourceTypeId smallint NOT NULL,
    ResourceSurrogateId bigint NOT NULL,
    SearchParamId smallint NOT NULL,
    Text nvarchar(256) COLLATE Latin1_General_CI_AI NOT NULL,
    TextOverflow nvarchar(max) COLLATE Latin1_General_CI_AI NULL,
    IsHistory bit NOT NULL DEFAULT 0,
    IsMin bit NOT NULL DEFAULT 0,
    IsMax bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_StringSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId, Text),
...
(
    ...
    IsHistory bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_NumberSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId),
...
(
    ...
    IsMin bit NOT NULL DEFAULT 0,
    IsMax bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_DateTimeSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId, StartDateTime),
...
(
    ...
    HighValue decimal(36,18) NULL,
    IsHistory bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_QuantitySearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId),
...
(
    ...
    IsHistory bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_ReferenceSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId, ReferenceResourceId),
...
(
    ...
    IsHistory bit NOT NULL DEFAULT 0,
    CONSTRAINT PK_UriSearchParam PRIMARY KEY (ResourceTypeId, ResourceSurrogateId, SearchParamId, Uri),
...
-- Seed ResourceType table with common FHIR resource types
...
PRINT 'Minimal FHIR schema created successfully';
GO
